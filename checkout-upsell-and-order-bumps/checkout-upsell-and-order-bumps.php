<?php
/**
 * Plugin Name:          UpsellWP – Upsell and Related Products Offers for WooCommerce
 ...
 * Requires PHP:         7.0
 * Author:               UpsellWP
 * Slug:                 checkout-upsell-and-order-bumps
 * Text Domain:          checkout-upsell-and-order-bumps
...
if (!cuw_pro_is_active()) {
    ...
    defined('CUW_VERSION') || define('CUW_VERSION', '2.2.8');
